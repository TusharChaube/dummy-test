...
function Sidebar() {
  ...
  return (
    <div className="sidebar">
      ...
      <NavLink to="/showfeed" activeClassName="active" style={{textDecoration: "none"}}><SidebarOption Icon={SearchIcon} text="Explore"/></NavLink>
      </Link> 
      ...
      <Link href="https://twitter.com/i/bookmarks" variant="body2">
